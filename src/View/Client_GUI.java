...
public class Client_GUI extends JFrame{
	...
	private Icon getIcon(int index, int index2, int size) {
		...
		java.net.URL location = getClass().getResource("/image/image" + index + "_" + index2 + ".png");
		if (location == null) {
			System.err.println("Resource not found: /image/image" + index + "_" + index2 + ".png");
			return null;
		}
	...
	public Client_GUI NewGame(int n, int x, int y, int color) { // tạo cửa sổ mới
		client.dispose();
